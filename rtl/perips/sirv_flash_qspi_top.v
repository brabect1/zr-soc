...
module sirv_flash_qspi_top(
  ...
  sirv_tlwidthwidget_qspi qspi_TLWidthWidget (
    .clock(clk),
    .reset(~rst_n),
    .io_in_0_a_ready(tl_ins_a_ready),
    .io_in_0_a_valid(tl_ins_a_valid),
    .io_in_0_a_bits_opcode(tl_ins_a_bits_opcode),
    .io_in_0_a_bits_param(tl_ins_a_bits_param),
    .io_in_0_a_bits_size(tl_ins_a_bits_size),
    .io_in_0_a_bits_source(tl_ins_a_bits_source),
    .io_in_0_a_bits_address(tl_ins_a_bits_address),
    .io_in_0_a_bits_mask(tl_ins_a_bits_mask),
    .io_in_0_a_bits_data(tl_ins_a_bits_data),
    .io_in_0_d_ready(tl_ins_d_ready),
    .io_in_0_d_valid(tl_ins_d_valid),
    .io_in_0_d_bits_opcode(tl_ins_d_bits_opcode),
    .io_in_0_d_bits_param(tl_ins_d_bits_param),
    .io_in_0_d_bits_size(tl_ins_d_bits_size),
    .io_in_0_d_bits_source(tl_ins_d_bits_source),
    .io_in_0_d_bits_sink(tl_ins_d_bits_sink),
    .io_in_0_d_bits_addr_lo(tl_ins_d_bits_addr_lo),
    .io_in_0_d_bits_data(tl_ins_d_bits_data),
    .io_in_0_d_bits_error(tl_ins_d_bits_error),
